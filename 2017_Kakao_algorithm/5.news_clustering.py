...
# Daum 뉴스의 개발 업무를 맡게 된 신입사원 튜브는 사용자들이 편리하게 다양한 뉴스를 찾아볼 수 있도록 문제점을
# 개선하는 업무를 맡게 되었다.
...
# 되므로, 집합 A, B 사이의 자카드 유사도 J(A, B) = 2/4 = 0.5가 된다.
...
def jaccard_index(dict1:dict, dict2:dict):
...
def solve(str1, str2):
    ...
    return jaccard_index(dict1, dict2)

sample1 = ["FRANCE", "french"]
sample2 =  ["handshake", "shake hands"]
sample3 = ["aa1+aa2", "AAAA12"]
sample4 = ["E=M*C^2", "e=m*c^2"]

samples = [sample1, sample2, sample3, sample4]

for sample in samples:
    print(solve(sample[0], sample[1]))
