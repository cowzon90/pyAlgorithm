...
sample1 = set(3,	["Jeju", "Pangyo", "Seoul", "NewYork", "LA", "Jeju", "Pangyo", "Seoul", "NewYork", "LA"])
sample2 = set(3,	["Jeju", "Pangyo", "Seoul", "Jeju", "Pangyo", "Seoul", "Jeju", "Pangyo", "Seoul"])
sample3 = set(2,	["Jeju", "Pangyo", "Seoul", "NewYork", "LA", "SanFrancisco", "Seoul", "Rome", "Paris", "Jeju", "NewYork", "Rome"])
sample4 = set(5,	["Jeju", "Pangyo", "Seoul", "NewYork", "LA", "SanFrancisco", "Seoul", "Rome", "Paris", "Jeju", "NewYork", "Rome"])
sample5 = set(2,	["Jeju", "Pangyo", "NewYork", "newyork"])
sample6 = set(0,	["Jeju", "Pangyo", "Seoul", "NewYork", "LA"])

samples = [sample1, sample2, sample3, sample4, sample5, sample6]

for sample in samples:
    print(caching(sample.size, sample.cities))